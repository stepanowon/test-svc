import { addTodo, deleteTodo, updateTodo, toggleDone, getTodoItem, getTodoList, createNewOwner } from "./tododao.js";
import sleep from "sleep-promise";

// 공통 핸들러 함수들
const createAsyncHandler = (handler, delay = 0) => {
  return delay > 0 ? (req, res) => sleep(delay).then(() => handler(req, res)) : handler;
};
